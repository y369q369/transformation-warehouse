...
def catalog_list(url):
    ...
    author = selector.css('#info h1 small a::text').get()
    chapter_list = []

    detail_list = selector.css('.zjbox .zjlist dd')
...
if __name__ == '__main__':
    url = 'https://www.qb5.tw/book_99041/'
